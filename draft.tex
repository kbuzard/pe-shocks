...
In this world that is far from first best, I next demonstrate how a WTO-styled escape clause can allow flexibility in the face of fundamental shocks $s$ while discouraging lobbyists from using the shock as cover for rent-seeking behavior. The timeline is as follows:
\begin{enumerate}
	...
	\item The exogenous shock $s$ is realized.
