...
\label{sec:objfcn}
The previous sections analyze in general the effects of various forms of trade agreements when political pressure is endogenous. I now use the specific functional forms for the economy given in Section~\ref{sec:stage} and compare government objective functions to understand the impact of trade agreements on government welfare.
