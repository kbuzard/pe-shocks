...
\begin{enumerate}
	...
	\item Page 17: `is invariant'
	\item Page 26: `an interior'
	\item I'm wondering why are the results referred to as `Results' and not `Propositions'?  Odd question when I put it like that!  But since we're used to `Propositions', saying `Results' is a bit distracting.  Or maybe I'm just being old fashioned ;-)
\end{enumerate}
