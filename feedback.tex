...
\begin{itemize}
	\item Richard: what happens if $\ga(e^L) < \ga(s^H)$?
	\item Dev: Reputation: do they use safeguards less b/c worried about reputation?
	\item Chris: What is an exogenous shock to political pressure? What signal would be correlated?
\end{itemize}
...
\begin{itemize}
	\item Export lobby at ex-post b/c wants to reduce chance of trade war
	\item $e$ in terms of numeraire
	\item Could escape clause be made to work with some fancier set up, e.g. dynamic use constraint?
\end{itemize}
