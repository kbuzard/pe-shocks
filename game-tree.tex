...
child{[white] node(2)[solid node,xshift=12,label=above:{L}]{}  
	...
	child{[white] node(5)[hollow node,xshift=12]{} 
	 ...
	 child{[black] node(22)[solid node]{}  }
	 ...
	 child{[black] node(23)[solid node]{}  }
...
% labels
		...
		\node[right]at (11) {$W_E\left(\btn\right),$};
		\node[right,yshift=-10]at (11) {$\pi\left(\tau^n\right)-e,$};
		\node[right,yshift=-20]at (11) {$W_{ML}\left(\ga(e_n,\ta_n),\btn\right)$};
\end{tikzpicture}
