...
\begin{enumerate}
	...
	\item More on escape clause / WEC
		\begin{itemize}
			...
			\item There is this drop off in usage of escape clause (EC) after Uruguay Round (UR) reforms, even though retaliation prohibited for first three years. Why, when retaliation goes \textit{away}?
				\begin{itemize}
					\item \textbf{perhaps better abel to respond to $\ga(e)$ before dispute settlement?}
				\end{itemize}
	...
	\item Take out repeats, especially of references to BS2005, rely to heavily on BS2005: In some parts the paper also seem repeating itself: you review Bagwell and Staiger (2005) in Section 2.2 but you provide another summary of the same paper in Section 3. Again, a revised structure may reduce the overlap, make the paper shorter, and be more to the point (and in general it seems to me that you seem to "dependent" on Bagwell and Staiger... (e.g. beginning of Sections 4 and 6).
