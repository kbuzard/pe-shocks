...
\section{Lobbying cost included in gov't welfare}
	\begin{itemize}
		...
		\item Kyle: why doesn't government (dis)value expenditure by lobby? Needs to be counted in government welfare function or justify why not
			...
			\end{itemize}
		\item Try subtracting $e$ and see what it does to the graphs. Does it give me the kind of non-monotonicity I'd like?
	\end{itemize}
...
\section{BS2005 vs. MRC2007}
	\begin{itemize}
		\item Review appendix of JIE_revision to see what connections I want to make
