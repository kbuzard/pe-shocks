	...
	\begin{itemize}
		...
		\item References from Krishna and Sadowski (2014) ECTA
				\begin{itemize}
					...
					\item Follow up on highlighted references in Kreps (1979): Strotz, which is about inconsistencies in discount function (non-exponential discounting).
					...
					\item Even better, especially advertising example: Becker, Gary. S. and George J. Stigler, ``De Gustibus Non Est Disputandum,'' The American Economic Review, Vol. 67, No. 2 (Mar., 1977), pp. 76-90
						\begin{itemize}
							\item I can make my argument almost exactly in analogy to this advertising example. My $\ga(e)$ function is like their $g(A)$.
							\item Check Kyle's Discussion paper on advertising to get context
						\end{itemize}
				\end{itemize}
